    ...
    return (
        <>
            <HeaderAndFooter>
                <div>
                    {/*Main Slider*/}
                    <div className="bg-[rgba(96,112,154,0.22)]">
                        <div
                            className="xl:pr-20 xl:pl-20 md:pr-10 md:pl-10 mx-10 pb-20 flex flex-wrap pt-10 justify-evenly gap-6">
                            <div className="w-96 flex flex-col gap-6 text-[#0C276A] leading-14">
                            ...
                            <img src={main} className="rounded-xl object-cover h-96 w-96"/>
                        </div>
                    </div>
                    {/*Hemayat ha*/}
                    <div className="bg-[#f5f5f5] p-10 xl:pr-20 xl:pl-20 md:pr-10 md:pl-10 flex flex-col gap-2">
                        <div className="flex flex-wrap justify-center gap-2">
                            <HemayatBox src={hemayat1} to={PAGES.helpTopic.url + "/" + PAGES.sports.url}
                                        label="حمایت ورزشی"/>
                            <HemayatBox src={hemayat2} to={PAGES.helpTopic.url + "/" + PAGES.supporting_students.url}
                                        label="حمایت از دانشجویان"/>
                            <HemayatBox src={hemayat3} to={PAGES.helpTopic.url + "/" + PAGES.cultural.url}
                                        label="حمایت فرهنگی"/>
                            <HemayatBox src={hemayat4} to={PAGES.helpTopic.url + "/" + PAGES.research.url}
                                        label="حمایت پژوهشی"/>
                            <HemayatBox src={hemayat5} to={PAGES.helpTopic.url + "/" + PAGES.construction.url}
                                        label="حمایت عمرانی"/>
                            <HemayatBox src={hemayat6} to={PAGES.helpTopic.url + "/" + PAGES.educational.url}
                                        label="حمایت آموزشی"/>
                        </div>
                    </div>
                    ...
                    <div className="bg-[rgba(96,112,154,0.22)]">
                        ...
                        {dataNews.length ?
                            <div className="mt-30 pb-20 xl:pr-20 xl:pl-20 md:pr-10 md:pl-10">
                    ...
                    {/*Hamian*/}
                    <div className="pb-16 pt-16 xl:pr-20 xl:pl-20 md:pr-10 md:pl-10 bg-[#f5f5f5]">
